...
<div class="boxHeader" id="dashboardRadiologyObs">Radiology
	Observations</div>
<div class="box">
	<table>
		<tr>
		...
		<table id="prevs">
			...
			<c:forEach items="${prevs}" begin="0" end="${prevsSize}" var="obs"
				...
				<tr>
					...
					<td><a
						href="module/radiology/portlets/radiologyObsDetailsDashboard.form?orderId=${obs.order.orderId }&obsId=${obs.obsId }"
						class="obsList"><spring:message code="general.view" /></a></td>
					<td>${obs.comment}</td>
				</tr>
			</c:forEach>
		</table>
