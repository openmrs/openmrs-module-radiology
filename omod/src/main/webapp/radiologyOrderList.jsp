	...
	<table id="searchForm" cellspacing="10">
		<tr>
			<td><label><spring:message
						code="radiology.patient" />:</label> <input name="patientQuery"
				type="text" style="width: 20em" title="<spring:message
						code="radiology.minChars" />"/></td>
			<td><label><spring:message
						code="radiology.startDate" />:</label> <input name="startDate"
				type="text" onclick="showCalendar(this)" /></td>
			<td><label><spring:message
						code="radiology.endDate" />:</label> <input name="finalDate"
				type="text" onclick="showCalendar(this)" /></td>
		</tr>
		<tr>
...
<c:if test="${not empty initialized}">
	<div id="init">
		<spring:message code="radiology.badInit" /><br/>
