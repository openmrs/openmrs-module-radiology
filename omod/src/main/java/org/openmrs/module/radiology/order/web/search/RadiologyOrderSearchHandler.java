...
public class RadiologyOrderSearchHandler implements SearchHandler {
     ...
     *         TODO it seems that its standard to return only non-voided data unless otherwise specified by a param. check
     *         and implement likewise. currently we only implement discontinuation which seems to be different from voiding
     *         an order.
     */
    @Override
