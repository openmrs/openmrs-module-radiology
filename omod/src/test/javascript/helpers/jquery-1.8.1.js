...
(function(window, undefined) {
  ...
  jQuery.fn = jQuery.prototype = {
    ...
    init: function(selector, context, rootjQuery) {
      ...
      } else if (jQuery.isFunction(selector)) { return rootjQuery
              .ready(selector); }
  ...
  jQuery
          .extend({
            ...
            parseHTML: function(data, context, scripts) {
              ...
              // Single tag
              if ((parsed = rsingleTag.exec(data))) { return [context
                      .createElement(parsed[1])]; }

              parsed = jQuery.buildFragment([data], context, scripts ? null
                      : []);
              return jQuery.merge([], (parsed.cacheable ? jQuery
                      .clone(parsed.fragment) : parsed.fragment).childNodes);
            },
            ...
            parseJSON: function(data) {
              ...
              if (window.JSON && window.JSON.parse) { return window.JSON
                      .parse(data); }
            ...
            proxy: function(fn, context) {
              ...
              proxy = function() {
                return fn.apply(context, args
                        .concat(core_slice.call(arguments)));
              };
      ...
      if (typeof data === "string") {
        try {
          data = data === "true" ? true : data === "false" ? false
                  ...
                  +data + "" === data ? +data : rbrace.test(data) ? jQuery
                          .parseJSON(data) : data;
        } catch (e) {
        }
              ...
              if (!arguments.length) {
                if (elem) {
                  ...
                  if (hooks && "get" in hooks
                          && (ret = hooks.get(elem, "value")) !== undefined) { return ret; }
  ...
  jQuery
          .extend({
            valHooks: {
              ...
              select: {
                get: function(elem) {
                  ...
                  if (one && !values.length && options.length) { return jQuery(
                          options[index]).val(); }
            ...
            attr: function(elem, name, value, pass) {
              ...
              if (pass && jQuery.isFunction(jQuery.fn[name])) { return jQuery(elem)[name]
                      (value); }

              // Fallback to prop when attributes are not supported
              if (typeof elem.getAttribute === "undefined") { return jQuery
            ...
            attrHooks: {
              ...
              value: {
                get: function(elem, name) {
                  if (nodeHook && jQuery.nodeName(elem, "button")) { return nodeHook
                          .get(elem, name); }
              ...
              tabIndex: {
                get: function(elem) {
                  ...
                  return attributeNode && attributeNode.specified ? parseInt(
                          attributeNode.value, 10) : rfocusable
                          .test(elem.nodeName)
                          || rclickable.test(elem.nodeName) && elem.href ? 0
                          : undefined;
                }
              }
            }
  ...
  jQuery.each(["radio", "checkbox"], function() {
    jQuery.valHooks[this] = jQuery.extend(jQuery.valHooks[this], {
      set: function(elem, value) {
        if (jQuery.isArray(value)) { return (elem.checked = jQuery.inArray(
  ...
  jQuery.event = {
    ...
    add: function(elem, types, handler, data, selector) {
      ...
      if (elem.nodeType === 3 || elem.nodeType === 8 || !types || !handler
              || !(elemData = jQuery._data(elem))) { return; }
    ...
    dispatch: function(event) {
      ...
      var i, j, cur, ret, selMatch, matched, matches, handleObj, sel, related, handlers = ((jQuery
              ._data(this, "events") || {})[event.type] || []), delegateCount = handlers.delegateCount, args = [].slice
    ...
    jQuery.event.special.change = {
      ...
      handle: function(event) {
        ...
        if (this !== elem || event.isSimulated || event.isTrigger
                || (elem.type !== "radio" && elem.type !== "checkbox")) { return event.handleObj.handler
  ...
  jQuery.fn
          .extend({
            ...
            triggerHandler: function(type, data) {
              if (this[0]) { return jQuery.event.trigger(type, data, this[0],
                      true); }
            },
  ...
  (function(window, undefined) {
    ...
    document = window.document, docElem = document.documentElement, done = 0, slice = [].slice, push = [].push,
    ...
    assertUsableClassName = assert(function(div) {
      ...
      if (!div.getElementsByClassName
              || !div.getElementsByClassName("e").length) { return false; }
      ...
      if (!xml && !seed) {
        if ((match = rquickExpr.exec(selector))) {
          ...
          if ((m = match[1])) {
            ...
            push.apply(results, slice
                    .call(context.getElementsByClassName(m), 0));
            return results;
          }
        }
      }
    ...
    Sizzle.attr = function(elem, name) {
      ...
      return attr ? typeof elem[name] === "boolean" ? elem[name] ? name : null
              : attr.specified ? attr.value : null : null;
    };
    ...
    Expr = Sizzle.selectors = {
      ...
      find: {
        ...
        "TAG": assertTagNameNoComments
                ? function(tag, context) {
                  if (typeof context.getElementsByTagName !== strundefined) { return context
        ...
        "NAME": function(tag, context) {
          if (typeof context.getElementsByName !== strundefined) { return context
                  .getElementsByName(name); }
        },

        "CLASS": function(className, context, xml) {
          if (typeof context.getElementsByClassName !== strundefined && !xml) { return context
      ...
      filter: {
        ...
        "CLASS": function(className) {
          ...
          if (!pattern) {
            pattern = classCache(className, new RegExp("(^|" + whitespace + ")"
        ...
        "ATTR": function(name, operator, check) {
          if (!operator) { return function(elem) {
      ...
      setFilters: {
        ...
        "gt": function(elements, argument, not) {
          return not ? elements.slice(0, +argument + 1) : elements
                  .slice(+argument + 1);
        },
    ...
    sortOrder = docElem.compareDocumentPosition
            ...
            : function(a, b) {
              ...
              } else if (a.sourceIndex && b.sourceIndex) { return a.sourceIndex
                      - b.sourceIndex; }
    ...
    function tokenize(selector, context, xml, parseOnly) {
      ...
      key = (checkContext ? "<s>" : "") + selector.replace(rtrim, "$1<s>"), cached = tokenCache[expando][key];
    ...
    function addCombinator(matcher, combinator, context, xml) {
      ...
      return combinator.first
              ? function(elem) {
                while ((elem = elem[dir])) {
                  if (elem.nodeType === 1) { return matcher(elem) && elem; }
                }
              }
              : xml
                      ? function(elem) {
                      ...
                      : function(elem) {
                        var cache, dirkey = doneName + "." + dirruns, cachedkey = dirkey
                                + "." + cachedruns;
                        while ((elem = elem[dir])) {
                          if (elem.nodeType === 1) {
    ...
    function handlePOS(groups, context, results, seed) {
      var group, part, j, groupLen, token, selector, anchor, elements, match, matched, lastIndex, currentContexts, not, i = 0, len = groups.length, rpos = matchExpr["POS"],
          ...
          if (token.part === "PSEUDO") {
            ...
            while ((match = rpos.exec(selector))) {
              ...
              if (lastIndex > anchor) {
                ...
                elements = handlePOSGroup(part, match[1], match[2],
                        currentContexts, elements, not);
              }
              part = "";
            }
    ...
    function select(selector, context, results, seed, xml) {
      ...
      var elements, matcher, cached, elem, i, tokens, token, lastToken, findContext, type, match = tokenize(
              selector, context, xml), contextNodeType = context.nodeType;

      // POS handling
      if (matchExpr["POS"].test(selector)) { return handlePOS(match, context,
              results, seed); }
      ...
      if (seed) {
        ...
        if ((tokens = slice.call(match[0], 0)).length > 2
                && (token = tokens[0]).part === "ID" && contextNodeType === 9
                && !xml && Expr.relative[tokens[1].part]) {

          context = Expr.find["ID"](token.captures[0].replace(rbackslash, ""),
                  context, xml)[0];
        ...
        findContext = ((match = rsibling.exec(tokens[0].string))
                && !match.index && context.parentNode)
                || context;
        ...
        for (i = tokens.length - 1; i >= 0; i--) {
          ...
          if (Expr.order.test(type)) {
            elements = Expr.find[type](token.captures[0]
    ...
    if (document.querySelectorAll) {
      (function() {
        ...
        rbuggyMatches = [":active"], matches = docElem.matchesSelector
                || docElem.mozMatchesSelector || docElem.webkitMatchesSelector
            ...
            if (context.nodeType === 9) {
              ...
              try {
                push.apply(results, slice.call(newContext
                        .querySelectorAll(groups.join(",")), 0));
                return results;
              } catch (qsaError) {
              } finally {
                if (!old) {
        ...
        if (matches) {
          assert(function(div) {
            ...
            try {
              ...
              rbuggyMatches.push(matchExpr["PSEUDO"].source,
  ...
  jQuery.fn.extend({
    find: function(selector) {
      ...
      if (typeof selector !== "string") { return jQuery(selector).filter(
              function() {
    ...
    is: function(selector) {
      return !!selector
              ...
              rneedsContext.test(selector) ? jQuery(selector, this.context)
                      .index(this[0]) >= 0
                      : jQuery.filter(selector, this).length > 0 : this
    ...
    closest: function(selectors, context) {
      var cur, i = 0, l = this.length, ret = [], pos = rneedsContext
              .test(selectors)
              || typeof selectors !== "string" ? jQuery(selectors, context
              || this.context) : 0;
    ...
    addBack: function(selector) {
      return this.add(selector == null ? this.prevObject : this.prevObject
              .filter(selector));
    }
  });
  ...
  jQuery.extend({
    ...
    dir: function(elem, dir, until) {
      ...
      while (cur
              && cur.nodeType !== 9
              && (until === undefined || cur.nodeType !== 1 || !jQuery(cur).is(
                      until))) {
        if (cur.nodeType === 1) {
          matched.push(cur);
        }
          ...
          .extend({
            ...
            replaceWith: function(value) {
              ...
              return this.length ? this.pushStack(jQuery(jQuery
                      .isFunction(value) ? value() : value), "replaceWith",
                      value) : this;
            },
            ...
            domManip: function(args, table, callback) {
              ...
              if (!jQuery.support.checkClone && l > 1
                      && typeof value === "string" && rchecked.test(value)) { return this
                      .each(function() {
                ...
                if (first) {
                  ...
                  for (iNoClone = results.cacheable || l - 1; i < l; i++) {
                    callback.call(table && jQuery.nodeName(this[i], "table")
                            ? findOrAppend(this[i], "tbody") : this[i],
                            i === iNoClone ? fragment : jQuery.clone(fragment,
                                    true, true));
                  }
                }
  ...
  function cloneCopyEvent(src, dest) {
    ...
    var type, i, l, oldData = jQuery._data(src), curData = jQuery._data(dest,
            oldData), events = oldData.events;
  ...
  jQuery.buildFragment = function(args, context, scripts) {
    ...
    if (args.length === 1 && typeof first === "string" && first.length < 512
            && context === document && first.charAt(0) === "<"
            && !rnocache.test(first)
                ...
                if (typeof elem === "string") {
                  if (!rhtml.test(elem)) {
                    ...
                    if (!jQuery.support.leadingWhitespace
                      ...
                      div.insertBefore(
                              context.createTextNode(rleadingWhitespace
  ...
  cssExpand = ["Top", "Right", "Bottom", "Left"], cssPrefixes = ["Webkit", "O",
      "Moz", "ms"],
  ...
  jQuery.fn
          .extend({
            ...
            toggle: function(state, fn2) {
              ...
              if (jQuery.isFunction(state) && jQuery.isFunction(fn2)) { return eventsToggle
                      .apply(this, arguments); }
  ...
  if (window.getComputedStyle) {
    curCSS = function(elem, name) {
      var ret, width, minWidth, maxWidth, computed = window.getComputedStyle(
              elem, null), style = elem.style;
  ...
  function inspectPrefiltersOrTransports(structure, options, originalOptions,
    ...
    var selection, list = structure[dataType], i = 0, length = list
            ...
            ajax: function(url, options) {
              ...
              function done(status, nativeStatusText, responses, headers) {
                ...
                if (fireGlobals) {
                  globalEventContext.trigger("ajax"
                          + (isSuccess ? "Success" : "Error"), [jqXHR, s,
              ...
              if (s.crossDomain == null) {
                ...
                s.crossDomain = !!(parts && (parts[1] != ajaxLocParts[1]
                        ...
                        ? 80 : 443)) != (ajaxLocParts[3] || (ajaxLocParts[1] === "http:"
                        ? 80 : 443))));
              }
  ...
  var fxNow, timerId, rfxtypes = /^(?:toggle|show|hide)$/, rfxnum = new RegExp(
    ...
    "*": [function(prop, value) {
      var end, unit, prevScale, tween = this.createTween(prop, value), parts = rfxnum
              .exec(value), target = tween.cur(), start = +target || 0, scale = 1;
  ...
  jQuery.each(["toggle", "show", "hide"], function(i, name) {
    ...
    jQuery.fn[name] = function(speed, easing, callback) {
      ...
      (!i && jQuery.isFunction(speed) && jQuery.isFunction(easing)) ? cssFn
              .apply(this, arguments) : this.animate(genFx(name, true), speed,
              easing, callback);
    };
  });
              ...
              return this
                      .each(function() {
                        var dequeue = true, index = type != null && type
                                + "queueHooks", timers = jQuery.timers, data = jQuery
                                ._data(this);
  ...
  jQuery.fn.offset = function(options) {
    if (arguments.length) { return options === undefined ? this : this
            .each(function(i) {
    ...
    if (!jQuery.contains(docElem, elem)) { return {
      top: 0,
      left: 0
    }; }
  ...
  jQuery.each({
    ...
    jQuery.fn[method] = function(val) {
      return jQuery.access(this, function(elem, method, val) {
        ...
        if (val === undefined) { return win ? (prop in win) ? win[prop]
