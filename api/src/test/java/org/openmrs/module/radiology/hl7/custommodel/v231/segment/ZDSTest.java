...
public class ZDSTest {
	...
	/**
	 * Tests the ZDS constructor and sets fields
	 * 
	 * @throws HL7Exception
	...
	/**
	 * Tests the ZDS.getStudyInstanceUID
	 * 
	 * @throws HL7Exception
	 * @see {@link ZDS#getStudyInstanceUID()}
	 */
	@Test
	@Verifies(value = "should return study instance uid", method = "getStudyInstanceUID()")
