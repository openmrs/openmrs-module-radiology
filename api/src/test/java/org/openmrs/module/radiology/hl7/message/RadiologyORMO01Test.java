...
/**
 * Tests methods in the {@link RadiologyORMO01}
 */
public class RadiologyORMO01Test {
	...
	public void getRadiologyORMO01Message_shouldReturnORMO01MessageWithOrderControlNWForGivenStudy() throws HL7Exception {
		...
		assertThat(ormMessageEncodedHL7String, startsWith("MSH|^~\\&|OpenMRSRadiologyModule|OpenMRS|||"));
		assertThat(
		    ormMessageEncodedHL7String,
