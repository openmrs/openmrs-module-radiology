...
/**
 * Tests methods in the {@link RadiologyPID}
 */
public class RadiologyPIDTest {
	...
	/**
	 * Tests the RadiologyPID.populatePatientIdentifier with Patient
	 * 
	 * @throws HL7Exception
	...
	/**
	 * Tests the RadiologyPID.populatePatientIdentifier with Patient including initialized but empty
	 * PersonName
	 * 
	 * @throws HL7Exception
	 * @see {@link RadiologyPID#populatePatientIdentifier(PID, Patient)}
	 */
	@Test
	@Verifies(value = "should return populated patient identifier segment for given patient with initialized but empty personname", method = "populatePatientIdentifier(PID, Patient)")
	public void populatePatientIdentifier_shouldReturnPopulatedPatientIdentifierSegmentForGivenPatientWithInitializedButEmptyPersonName()
	        throws HL7Exception {
	...
	/**
	 * Tests the RadiologyPID.populatePatientIdentifier with Patient with non-set PersonName
	 * 
	 * @throws HL7Exception
	 * @see {@link RadiologyPID#populatePatientIdentifier(PID, Patient)}
	 */
	...
	/**
	 * Tests the RadiologyPID.populatePatientIdentifier with Patient with non-set Gender
	 * 
	 * @throws HL7Exception
	 * @see {@link RadiologyPID#populatePatientIdentifier(PID, Patient)}
	 */
	...
	/**
	 * Tests the RadiologyPID.populatePatientIdentifier passing null as Patient
	 * 
	 * @throws HL7Exception
	 * @see {@link RadiologyPID#populatePatientIdentifier(PID, Patient)}
	 */
	...
	/**
	 * Tests the RadiologyPID.populatePatientIdentifier passing null as patientIdentifierSegment
	 * 
	 * @throws HL7Exception
	 * @see {@link RadiologyPID#populatePatientIdentifier(PID, Patient)}
	 */
	...
	/**
	 * Tests the RadiologyPID.populatePatientIdentifier with Patient with no PatientIdentifier
	 * 
	 * @throws HL7Exception
	 * @see {@link RadiologyPID#populatePatientIdentifier(PID, Patient)}
	 */
