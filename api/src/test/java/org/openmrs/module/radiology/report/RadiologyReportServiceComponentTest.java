...
public class RadiologyReportServiceComponentTest extends BaseModuleContextSensitiveTest {
    ...
    /**
    * @see RadiologyReportService#getRadiologyReportByRadiologyReportUuid(String)
    * @verifies fetch RadiologyReport matching given radiologyReportUuid
    */
    @Test
    public void getRadiologyReportByRadiologyReportUuid_shouldFetchRadiologyReportMatchingGivenRadiologyReportUuid()
            throws Exception {
        
        RadiologyReport radiologyReport =
                radiologyReportService.getRadiologyReportByRadiologyReportUuid(EXISTING_RADIOLOGY_REPORT_UUID);
    ...
    */
    @Test
    public void getRadiologyReportByRadiologyReportUuid_shouldThrowIllegalArgumentExceptionIfRadiologyReportUuidIsNull()
            throws Exception {
        
        expectedException.expect(IllegalArgumentException.class);
        expectedException.expectMessage("radiologyReportUuid cannot be null");
        radiologyReportService.getRadiologyReportByRadiologyReportUuid(null);
    }
    ...
    */
    @Test
    public void getRadiologyReportByRadiologyReportUuid_shouldReturnNullIfNoRadiologyReportFoundWithGivenUuid()
            throws Exception {
        
        RadiologyReport radiologyReport =
                radiologyReportService.getRadiologyReportByRadiologyReportUuid(NON_EXISTING_RADIOLOGY_REPORT_UUID);
