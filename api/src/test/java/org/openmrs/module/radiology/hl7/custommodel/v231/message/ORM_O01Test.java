...
public class ORM_O01Test {
	...
	public void ORM_O01_shouldCreateNewORMO01Instance() throws HL7Exception {
		...
		mshCustom.getEncodingCharacters()
				.setValue("^~\\&");
		mshCustom.getVersionID()
				.getVersionID()
				.setValue("2.3.1");
		mshCustom.getMessageType()
				.getMessageType()
				.setValue("ORM");
		mshCustom.getMessageType()
				.getTriggerEvent()
				.setValue("O01");
		mshCustom.getSendingApplication()
				.getNamespaceID()
				.setValue("OpenMRSRadiologyModule");
		mshCustom.getSendingFacility()
				.getNamespaceID()
				.setValue("OpenMRS");
		mshCustom.getProcessingID()
				.getProcessingID()
				.setValue("P");
		mshCustom.getDateTimeOfMessage()
				.getTimeOfAnEvent()
				.setValue("20130827154500");
		
		PID pid = customOrmMessage.getPIDPD1NTEPV1PV2IN1IN2IN3GT1AL1()
				.getPID();
		...
		ORC orc = customOrmMessage.getORCOBRRQDRQ1ODSODTRXONTEDG1RXRRXCNTEOBXNTECTIBLG()
				.getORC();
		orc.getOrderControl()
				.setValue("NW");
		...
		obr.getUniversalServiceID()
				.getAlternateText()
				.setValue("CT ABDOMEN PANCREAS WITH IV CONTRAST");
		obr.getPlacerField2()
				.setValue("2");
		obr.getFillerField1()
				.setValue("2");
