...
//        try {
//            URL config = this.getClass().getResource("/weasis-connector.properties");
//            if (config == null) {
...
//            Context.openSession();
//            String pacsAET = pacsProperties.getProperty("pacs.aet", Utils.aeTitle());
//            String pacsHost = pacsProperties.getProperty("pacs.host", Utils.serversAddress());
//            int pacsPort = Integer.parseInt(pacsProperties.getProperty("pacs.port", Utils.storagePort()));
