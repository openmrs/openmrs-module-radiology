...
/**
 * A class that will return an URL to open dicom images of a given study in
 * the configured dicomviewer. 
 */
@Component
public class DicomViewer {
	...
	/**
	 *@should return a url to open dicom images of the given study in the configured dicom viewer (no matter if the study is completed or not)
