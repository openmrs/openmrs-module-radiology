...
public class RadiologyORC {
	...
	/**
	 * Fill HL7 Common Order Segment (ORC) with data from given OpenMRS Study and Order
	 * 
	 ...
	 * @should return populated common order segment for given study and order
	 * @should fail given null as commonOrderSegment
