...
public interface MrrtReportTemplateService extends OpenmrsService {
    ...
    * <strong>Should</strong> save given template
    * <strong>Should</strong> throw api exception if saving template that already exists
    * <strong>Should</strong> save template object with terms if matching concept reference term was found
    */
     ...
     * <strong>Should</strong> create mrrt report template in the database and on the file system
     * <strong>Should</strong> not create an mrrt report template in the database and store the template as file if given template is invalid
     */
    @Authorized(RadiologyPrivileges.ADD_RADIOLOGY_REPORT_TEMPLATES)
     ...
     * @throws IllegalArgumentException if given null
     * <strong>Should</strong> delete report template from database and also delete template file from the system
     * <strong>Should</strong> throw illegal argument exception if given null
     * <strong>Should</strong> catch file not found exception when the file been deleted is missing
     */
     ...
     * @throws IllegalArgumentException if given null
     * <strong>Should</strong> get template with given id
     ...
     * @throws IllegalArgumentException if given null
     * <strong>Should</strong> find object given existing uuid
     ...
     * @throws IllegalArgumentException if given null
     * <strong>Should</strong> find object with given identifier
     * <strong>Should</strong> return null if no object found with given identifier
     * <strong>Should</strong> throw illegal argument exception if given null
     */
    @Authorized(RadiologyPrivileges.GET_RADIOLOGY_REPORT_TEMPLATES)
     ...
     * @throws IllegalArgumentException if given null
     * <strong>Should</strong> return all mrrt report templates that match given title search query if title is specified
     * <strong>Should</strong> return an empty list if no match for title was found
     * <strong>Should</strong> throw illegal argument exception if given null
     * <strong>Should</strong> return all mrrt report templates that match given publisher anywhere in dcterms publisher insensitive to case
     * <strong>Should</strong> return an empty list if no match for publisher was found
     * <strong>Should</strong> return all mrrt report templates that match given license anywhere in dcterms license insensitive to case
     * <strong>Should</strong> return an empty list if no match for license was found
     * <strong>Should</strong> return all mrrt report templates that match given creator anywhere in dcterms creator insensitive to case
     * <strong>Should</strong> return an empty list if no match for creator was found
     */
    @Authorized(RadiologyPrivileges.GET_RADIOLOGY_REPORT_TEMPLATES)
     ...
     * <strong>Should</strong> return the body content of the mrrt report template file
     * <strong>Should</strong> throw illegal argument exception if given null
     */
