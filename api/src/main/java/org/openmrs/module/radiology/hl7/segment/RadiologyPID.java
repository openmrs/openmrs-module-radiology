...
public class RadiologyPID {
	...
	/**
	 * Fill HL7 Patient Identification Segment (PID) with data from given OpenMRS Patient
	 * 
	 ...
	 * @should return populated patient identifier segment for given patient with initialized but
	 *         empty personname
