...
public class RadiologyMSH {
	...
	/**
	 * Fill HL7 Message Header (MSH) with Sending Facility, Date/Time Of Message, Message Type (type
	 * and trigger event) from parameters. Field Separator, Encoding Characters, Processing ID,
	 * Version ID from constants.
	 * 
	 ...
	 * @should return populated message header segment given empty sending facility
	 * @should return populated message header segment given null date time of message
	 * @should fail given null as messageHeaderSegment
	 */
